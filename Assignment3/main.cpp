...
void TestQueueStack()
{
	...
	assert(qs.GetMin() == 0);
	assert(qs.GetSum() == 4);
	assert(std::abs(qs.GetAverage() - 2) <= EPSILON);
	...
	assert(qs.GetMin() == -3);
	assert(qs.GetSum() == 13);
	assert(std::abs(qs.GetAverage() - 2.6) <= EPSILON);
	...
	assert(std::abs(qs2.GetAverage() - 2.6) <= EPSILON);
	...
	assert(qs.GetMin() == -3);
	assert(qs.GetSum() == 9);
	assert(std::abs(qs.GetAverage() - 2.25) <= EPSILON);
	assert(qs.GetCount() == 4u);
	assert(qs.GetStackCount() == 3u);
	...
	assert(qs.GetMin() == -3);
	assert(qs.GetSum() == 2);
	assert(std::abs(qs.GetAverage() - 1) <= EPSILON);
	assert(qs.GetCount() == 2u);
	assert(qs.GetStackCount() == 2u);
	...
	assert(qs.GetMin() == -8);
	assert(qs.GetSum() == -2);
	assert(std::abs(qs.GetAverage() - (- 0.4)) <= EPSILON);
	assert(qs.GetCount() == 5u);
	assert(qs.GetStackCount() == 3u);
	...
	assert(qs.GetMin() == -8);
	assert(qs.GetSum() == 1);
	assert(std::abs(qs.GetAverage() - 0.25) <= EPSILON);
	assert(qs.GetCount() == 4u);
	assert(qs.GetStackCount() == 2u);
	...
	assert(qs.GetMin() == -8);
	assert(qs.GetSum() == -8);
	assert(std::abs(qs.GetAverage() - (- 8)) <= EPSILON);
	assert(qs.GetCount() == 1u);
	assert(qs.GetStackCount() == 1u);
